...
docker run -d \
  ...
  -e AFTERGRAPH_CORS_ORIGINS="https://work-intelligence.aftergraph.org" \
...
- backend: `172.17.0.1:8090`, exposed as `https://work-intelligence.aftergraph.org`
- frontend: VDS port `3001`, exposed as `https://work-intelligence.aftergraph.org`
...
```bash
API=https://work-intelligence.aftergraph.org/api
